import { Component, ElementRef, Input, OnInit, Output, EventEmitter, Renderer2} from '@angular/core';

@Component({
  selector: 'ngx-progressive-img-loader',
  template: `
  <div class="ngx-progressive-img-container" [ngStyle]="{'background-color': placeholderBgColor, 'height': height, 'width': width}">
  <div class="ngx-progressive-img-container-default-bg">
      <div class="ngx-progressive-img-container-high-res-container">
      </div>
       <div class="ngx-progressive-img-container-low-res-container">
  </div>
  </div>
  <div class="ngx-progressive-img-container-overlay" [ngStyle]="{'height': height, 'width': width, 'background-color': overlayTint}"></div>
...
@keyframes ngx-preloader-img-reveal-animation {
  0% { transform: scale(1.05); opacity: 0; -webkit-transform: scale(1.05); -moz-transform: scale(1.05); -ms-transform: scale(1.05); -o-transform: scale(1.05); }
  100% { transform: scale(1); opacity: 1; -webkit-transform: scale(1); -moz-transform: scale(1); -ms-transform: scale(1); -o-transform: scale(1); }
}
  ...
  // high resolution image url (required)
    ...
    ngOnInit() {
      ...
      if (this.placeholderImg) {
        let placeholder : any = this
          .el
          .nativeElement
          .querySelector('.ngx-progressive-img-container-default-bg');
    ...
    loadImage() {
      let thumbnailContainer : any = this
        .el
        .nativeElement
        .querySelector('.ngx-progressive-img-container-low-res-container');
      let originalImageContainer : any = this
        .el
        .nativeElement
        .querySelector('.ngx-progressive-img-container-high-res-container');
      let placeholder : any = this
        .el
        .nativeElement
        .querySelector('.ngx-progressive-img-container-default-bg');
      ...
      thumb.onload = function (e) {
        ...
        this
          .rd
          .appendChild(thumbnailContainer, thumb);
        this
          .thumbnailLoaded
          .emit({loaded: true, event: e});
      }.bind(this);

      thumb.onerror = function (e) {
        this
          .thumbnailLoaded
          .emit({loaded: false, event: e});
      }.bind(this);
      ...
      highRes.onload = function (e) {
        ...
        highRes
          .classList
          .add('ngx-preloader-img-reveal');
        // inject the loaded thumbnail into its container
        this
          .rd
          .appendChild(originalImageContainer, highRes);
        this
          .imageLoaded
          .emit({loaded: true, event: e});
